...
public class Melody : Pasajero
{
    ...
    public override void addDialogue()
    {
        ...
        addTurnLeftDialogue("W-Wait, could you please turn left? **",Dialogue.emotions.angry);
        addTurnRightDialogue("W-Wait, could you please turn right? **",Dialogue.emotions.angry);
